<%@ Page Title="Hotel Payment" Language="C#" MasterPageFile="~/USER/master.Master" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="WebApplication1.USER.payment" %>
          ...
          <div class="col-12 pt-5 mb-5">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                  <p>We have cash-on-delivery and online payment option to make your puchase done. </p>
              ...
              <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <p class="pl-3">We also accept payment from online.</p>
                  <asp:Button ID="paytm" OnClick="paytm_Click" class="btn btn-primary pl-5 pr-5 ml-5" runat="server" Text="Paytm" />
              </div>
              <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                   <h2 class="pl-2">-Pay at your door.</h2>
                  <p class="pl-3">We also accept cash on delivery.</p>
                  <asp:Button ID="cashondelivery" OnClick="cashondelivery_Click" class="btn btn-primary pl-5 pr-5 ml-5" runat="server" Text="Cash on Delivery" />
              </div>
            </div>
